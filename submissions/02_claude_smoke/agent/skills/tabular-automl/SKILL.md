...
python skills/tabular-automl/scripts/run_automl.py --mode full --out sub_full.csv
python skills/tabular-automl/scripts/run_automl.py --mode blend --members lgbm_reg,logreg --out sub_blend.csv
```
